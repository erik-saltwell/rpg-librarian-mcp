...
from rpg_librarian_tools.files import inspect_file

from ..catalog import Catalog
from ..db import session_scope
from ..infrastructure.entry_queries import entries_by_parent, entries_under
from ..infrastructure.path_helper import walk_filesystem
...
def generate_sha256(path: Path) -> str:
    """Compatibility seam for catalog error handling and its focused tests."""
...
def _compute_entry_fields(path: Path) -> EntryFields:
    ...
    return EntryFields(
        ...
        size_in_bytes=inspection.size_in_bytes,
